...
export default function App() {
  ...
  // ================= QUESTIONS (10 EACH SUBJECT = 50 TOTAL) =================
  const questions = [
    ...
    { q: "Momentum is defined as?", options: ["mv", "ma", "F/t", "V/d"], a: "mv", subject: "Physics" },
    ...
    { q: "Velocity at highest point of projectile is?", options: ["0", "max", "constant", "infinite"], a: "0", subject: "Physics" },
    { q: "Acceleration due to gravity is approximately?", options: ["9.8 m/s²", "10 m/s²", "5 m/s²", "1 m/s²"], a: "9.8 m/s²", subject: "Physics" },
    { q: "Energy conservation applies when?", options: ["no friction", "heat", "pressure", "mass change"], a: "no friction", subject: "Physics" },
    ...
    { q: "Oxidation means?", options: ["loss of electrons", "gain of electrons", "gain of neutrons", "loss of protons"], a: "loss of electrons", subject: "Chemistry" },
    { q: "Reduction means?", options: ["gain of electrons", "loss of electrons", "gain of protons", "loss of neutrons"], a: "gain of electrons", subject: "Chemistry" },
    { q: "Periodic table is arranged by?", options: ["atomic number", "mass", "density", "volume"], a: "atomic number", subject: "Chemistry" },
    { q: "Catalyst affects?", options: ["rate", "mass", "volume", "temperature"], a: "rate", subject: "Chemistry" },
    ...
    { q: "Mitosis produces?", options: ["2 identical cells", "4 cells", "mutations", "no cells"], a: "2 identical cells", subject: "Biology" },
    ...
    // ================= MATHEMATICS =================
    { q: "Solve x² - 5x + 6 = 0", options: ["2 and 3", "1 and 6", "3 and 5", "4 and 5"], a: "2 and 3", subject: "Math" },
    ...
    { q: "Factor theorem is used for?", options: ["roots", "addition", "division", "multiplication"], a: "roots", subject: "Math" },
    ...
    { q: "Declarative sentence makes?", options: ["statement", "question", "command", "exclamation"], a: "statement", subject: "GST" },
    { q: "Interrogative sentence is?", options: ["question", "statement", "command", "phrase"], a: "question", subject: "GST" },
    { q: "Prefix is placed at?", options: ["beginning", "end", "middle", "random"], a: "beginning", subject: "GST" },
    { q: "Simple sentence has?", options: ["1 clause", "2 clauses", "3 clauses", "none"], a: "1 clause", subject: "GST" },
    { q: "Compound sentence uses?", options: ["and/but", "noun", "verb", "adjective"], a: "and/but", subject: "GST" },
